...
ratelimited_test_runner!(run_ratelimited_tests, [
    ...
    make_client_test!(get_manga_recommendations, client, client.get_manga_recommendations(1)),
    make_client_test!(get_manga_userupdates, client, client.get_manga_userupdates(1, Some(1))),
    make_client_test!(get_manga_reviews, client, client.get_manga_reviews(1, Some(1), None, None)),
